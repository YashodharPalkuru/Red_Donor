...
<body>
  ...
  <nav class="navbar  navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="row">
     	...
     	<h3 align="center" hidden= "isObject(${facebook.id});" >Its Glad to see you ${facebook.name} , please complete the following section.</h3>
  
     	<h3 align="center">Its Glad to see you ${model.userId} , please complete the following section.</h3>
     	
     	</div>
        <div class="col-sm-6 col-md-4 col-md-offset-4">
        
        	<form class="form-signin" action="register2.htm" method="POST">
        	<input type="hidden" name="usrID" id ="usrID" value=${model.userId}/>
